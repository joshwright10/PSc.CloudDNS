function ConvertFrom-PScDNSCSCCNAMERecord {
    <#
    .SYNOPSIS
        Converts a CSC CNAME Record into one or more PScDNSRecordSet objects.

    .DESCRIPTION
        The ConvertFrom-PScDNSCSCCNAMERecord function parses a line from a CSC zone export and converts it into a PScDNSRecordSet object.
    ...
    .EXAMPLE
        PS C:\> ConvertFrom-PScDNSCSCCNAMERecord -InputObject $Records -Domain "example.com"
